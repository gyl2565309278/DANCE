...
__all__ = ["GeneralizedWSRCNN"]


@META_ARCH_REGISTRY.register()
class GeneralizedWSRCNN(nn.Module):
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            cpg: category-specific pixel gradient map used in the CSC method proposed
                in https://ieeexplore.ieee.org/document/8809899/.
        """
        super().__init__()
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            "cpg": True if "CSC" in cfg.MODEL.ROI_HEADS.NAME else False,
        }
    ...
    def inference(
        ...
        if do_postprocess:
            ...
            results, all_boxes = GeneralizedWSRCNN._postprocess(
    ...
    def _postprocess(
        ...
        for results_per_image, input_per_image, boxes_per_image, image_size in zip(
            ...
            r, b = detector_postprocess(results_per_image, boxes_per_image, height, width)
