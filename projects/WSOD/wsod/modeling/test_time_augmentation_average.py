...
__all__ = ["DatasetMapperTTAAverage", "GeneralizedRCNNWSWithTTAAverage"]
...
class DatasetMapperTTAAverage:
    ...
    def __init__(
        ...
        Args:
            ...
            resize_shortest_edge: whether to resize the shorter edge or the longer edge of an image
        """
    ...
    def __call__(self, dataset_dict):
        ...
        for min_size in self.min_sizes:
            if self.resize_shortest_edge:
                resize = ResizeShortestEdge(min_size, self.max_size)
            else:
                resize = ResizeLongestEdge(min_size, self.max_size)
...
class GeneralizedRCNNWSWithTTAAverage(nn.Module):
    """
    ...
    def __call__(self, batched_inputs):
        ...
        return [self._inference_one_image(_maybe_read_image(x)) for x in batched_inputs], None, None
