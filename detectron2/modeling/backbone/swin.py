...
def build_swin_backbone(cfg, input_shape: ShapeSpec):
    """
    ...
    Returns:
        Swin Transformer (SwinTransformer): backbone module, must be a subclass of :class:`Backbone`.
    """
    # fmt: off
    ...
    use_abs_pos            = cfg.MODEL.SWIN.USE_ABS_POS
